...
<!-- Features (Section A – darker) -->
<section id="features" class="section section-a">
  <div class="container">
...
<!-- How it works (Section B – lighter dark) -->
<section id="how" class="section section-b">
  <div class="container">
    <div class="text-center mb-5">
...
<!-- FAQ -->
<section id="faq" class="section section-a">
  <div class="container">
    <div class="text-center mb-5">
